...
The data is almost a normal distribution, but it is slightly negatively skewed. Most of the songs fall between the first standard deviation and are close to the mean. The mean and standard deviation tell us that the songs are relatively danceable. I would write a story on how the most successful songs on Spotify tend to be the danceable ones. This would mean that in today’s society, there’s less of a desire for slow songs. People just want to move to music. Artists who don’t release danceable songs are therefore taking a risk and not conforming to the expectations of the music industry, which could make it more difficult for them to find success.
