...
**WRITE YOUR ANSWER HERE**: The median rate nearly tripled from the 22.2 in the pre-spike to 58.1 in the spike year but the sample sizes varied a great deal, with 71 observations in pre-spike versus 12 in the spike year. The average number of car thefts post-strike was over 200 more than pre-strike.
...
The chart shows that car theft rates were very low from 2018 to 2022 and experienced a dramatic increase in 2023, nearly tripling the previous monthly averages.
New Title: Car theft rates heighten in 2023 but have declined since
...
- **Null Hypothesis (H0)**:   There is no significant difference in crime theft rates between the pre-spike, spike year and post spike periods.

- **Alternative Hypothesis (H1)**: There is a significant difference in crime theft rates between the pre-spike, spike year and post spike periods.
...
**The p-valye is far below the 0.5 average and is therefore statistically significant. This, along with the F value of 218, help conclude that the null hypothesis is false and the car theft rates differ greatly by period.**
...
**WRITE ANSER HERE:** There is a significant difference between the three periods. The difference between the pre-spike and post-spike periods is real and significant because there is a difference of 20 thefts between the two periods, with the post-spike period having the higher amount.

Headline: Car Thefts Remain Higher Than Years Prior to the Spike in 2023.
Lede: The rate of monthly car thefts surged in 2023, and while the numbers have decreased since, there are still significantly more car thefts than before the spike year.
