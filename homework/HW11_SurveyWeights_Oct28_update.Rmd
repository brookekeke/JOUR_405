...
**Education levels in the survey sample might differ from the general population because respondents with at least some college education make up nearly 70% of the population, whereas respondents with only high school or less make up around 30% of the sample. A lower education group might be underrepresented because they might not have been able to get a higher education due to finances or location, so due to lack of accessibility, they might be less likely to respond to surveys. Generally, people with higher educations are more likely to respond to surveys.**
...
**College graduates are more likely to vote than those without a college education**
...
**After applying the weights, the percentage of individuals with high school education or less changed, with the percentage of those who answered Yes decreasing by nearly 3 percentage points. The percentage of individuals with at least some college experience stayed relatively the same, with all of the new percentages staying within one point from the original value.**

2. Why might the weighted results be considered more accurate than the unweighted results?

**The weighted results might be considered more accurate than the unweighted results because they balance out the amount of respondents for each group which helps the results to better reflect the population.**
...
**Individuals with high school education or less show the largest difference between weighted and unweighted results.**
...
**It's important for journalists to understand survey weighting when reporting on polls because the results of a survey can change depending on whether it is weighted or not. Weighting results can better reflect the population, however it's important to clarify to the reader that it's weighted because it could also sway the results.**

2. How might the differences between weighted and unweighted results affect how you would report on this data?

**In this example, the weighted and unweighted results aren't very different so it wouldn't have a large affect on my reporting of the data. However, if I decided to use the weighted results, I would make sure to clarify that in my story.**
...
**Before using this data in a news story, I would want to know the specifics in how the weights were determined, like how factors like age, race and gender had an influence.**
