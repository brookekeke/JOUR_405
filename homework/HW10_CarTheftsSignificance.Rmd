...
**WRITE ANSWERS HERE:** The number of monthly car thefts have decreased over time, from July 2023 to January 2025.
...
- What does the 95% confidence interval show here? **WRITE ANSWER HERE:** The confidence interval shows that the mean car thefts from July 2023 to January 2025 is 460.4.

- What figure(s) accurately reflects the number of car thefts in a typical month? **WRITE ANSWER HERE:** The mean of 460 car thefts reflects the number of car thefts in a typical month.

- Propose a headline about the trend in car thefts that is focused on the present and future, but informed by the data you see above. **WRITE ANSWER HERE:** Car thefts have recently declined, falling below the typical monthly average of 460.
...
Given the above chart, is the difference between the two periods statistically significant? Can we reject the null hypothesis? **WRITE ANSWER HERE:** The difference is statistically significant because there is a difference of nearly 60 thefts between the first and second half of the time period.

How would you revise your headline from Task 6, if at all? What would you tell your editor, and what would you expect her to ask you? **WRITE ANSWER HERE:** I would maintain the same headline because I feel it still reflects this information. If I were to adjust it, rather than comparing current trends to the average, I would compare it to the high number of thefts in the first half of the time period.
