...
Titles that I would have assumed to be well paid are actually unpaid. I would like to do further research to identify if this is actually the case or if they get compensated some other way. The salary values that are 0 and above 250,000 could cause problems for my analysis because they are outliers.
