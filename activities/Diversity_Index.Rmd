...
**The data contains the number of people of a certain race within a city's population. Baltimore City, Silver Spring and Waldorf stand out as diverse.**
...
**Summerfield has the highest race probability. This is because there is a large black population of 93%. This is 11,565 residents out of the total population of 12,403.**
...
**The cities with the lowest Hispanic probability scores have a pretty evenly spread out variation of races and ethnicity among the population.**
...
**Langely Park, Wheaton and Adelphi are the top three. They are located near College Park and relatively close to D.C. Lake Shore is the least diverse and it's by the water.**
...
**ANSWER HERE**
Headline: Diversity Split In D.C. Suburbs
Lede: Data shows that suburbs of D.C. have some of the most and least diverse populations. Cities like Langely Park and Wheaton have  high diversity index scores, meaning there's a high probability that two randomly selected residents do not share the same race or ethnicities. Other cities in the subarbs, like Lake Shore, however, had the lowest diversity index score.

I would talk to residents of the most diverse cities like Langely Park and Wheaton and residents of less diverse cities like Lake Shore. The questions would revolve around how they see diversity in their area. Was it an important factor when deciding where to live? Is there any particular reason this city is more or less diverse? How does the diversity or lack there of influence your satisfaction of the town? Have you noticed anything different in recent years?
