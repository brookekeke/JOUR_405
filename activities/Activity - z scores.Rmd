...
**Daily calls peak in October and decrease in the time after before heightening again in January.**
...
**The unusual days are outliers, eiher dramatically higher or lower than the normal days. I only talked about the unusually high scores in Task 3, disregarding the unusually low scores.**
...
***Tuesdays have significantly more daily calls on average, with the greatest standard deviation from the mean. I would research is any particular events/activities happen on Tuesdays that could influence this high number of calls.**
