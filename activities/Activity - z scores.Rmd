...
**Daily calls peak in October and decrease in the time after before heightening again in January. There are some fairly significant increases and decreases from April 2022 to January 2023. These numbers deviate from the more common values and could indicate a higher z-score for those specific times.**
...
**The unusual days are outliers, either dramatically higher or lower than the normal days. Unusually high days are fairly rare and stand far above the pattern. The unusually low days aren't as far from the pattern. Compared to my answer on Task 3, this new plot shows that not every dramatic increase/decrease is statistically significant. Many of the points in Task 3 appear to be high, but this new plot shows only a few that are actually red and significant. Additionally, I only talked about the unusually high scores in Task 3, disregarding the unusually low scores.**
...
**Tuesdays and Thursdays are considered unusual because their z-score is greater than 3. Every other day of the week is not unusual, but warrants investigation because they are greater than 2.**
...
***Tuesdays have significantly more daily calls on average, with the greatest standard deviation from the mean. I would research is any particular events/activities happen on those days that could influence this high number of calls.**
