...
Residents living near the transit line have claimed that home prices has increased over recent years. A new test shows that the results are highly significant since the result is higher than the base test value. The previous average of house sale price was $285K and has been increasing. 
