...
**Write your answers here:** It is not statistically justified because the percentages alone show that only around half of each population supports the New City Policy. There is a high margin of error for the sample size of 100, so the percentage of residents in support of the policy for the first sample size could be above 60%, but that still doesn't justify the claim that the majority supports the policy. A new headline would be: City residents are split in their support for the New City Policy.
...
Residents living near the transit line have claimed that house prices has increased over recent years. A new test shows that the results are highly significant since the result is higher than the base test value. The previous average of house sale price was $285K and has been increasing. 
