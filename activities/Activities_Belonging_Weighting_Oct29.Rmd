...
**YOUR NAME HERE: Brooke Ensminger
...
**Write your answer here:** The sample size isn't reflective of the diverse population, with an lack of sampling for several races/ethnicities. For example, UMD has a large population of Jewish students, yet they only made up a very small amount of the sample. The gender expansive category might be problematic because it generalizes the category and groups several different identities together. Another statement that raised concern was how they measured undergraduates. It said they surveyed first generation students, but this means they left out second and third generation students.
...
1. What is the range of weights in this dataset? **Write your answer here:** The data ranges from 0.2298 to 3.0386.

2. What does it mean when a respondent has a weight of 0.23? What about 3.04? **Write your answer here:** When a respondent has a weight of 0.23, it means it's weighted less, whereas a weight of 3.04 is weighted more.

3. Why might some respondents be weighted more heavily than others? **Write your answer here:** Some respondents might be weighted more heavily than others because they represent a much higher part of the sample and are more likely to respond.
...
1. Which voter category shows the biggest difference between weighted and unweighted results? **Write your answer here:** The "rarely/never" voter category shows the biggest difference between weighted and unweighted results. It ranges from -3.56013712 to 1.9985288.

2. How might these differences affect reporting on likely voter turnout? **Write your answer here:** These differences show that the results differ before and after being weighted. The reporting will then be more accurate of the voter turnout in the population because the various groups of respondents would be more evenly balanced.

3. Why do you think these differences exist? What does this tell us about who might be over or under-represented in the sample? **Write your answer here:** These differences exist to create a more balanced representation of voters in the population. This way, one category doesn't overpower the data. It tells us that people who answer surveys would be over-represented and people who don't answer surveys would be under-represented.
