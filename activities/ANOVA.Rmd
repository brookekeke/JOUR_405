...
**Task 3: Write your answer here: The average SAT score at a community college is much lower than that at a private or public college. The community college mean is around 300 less than public and private. The standard deviation for community college SAT scores is significantly greater than the others. The minimum score of at the community college was 786.52, which is nearly 500 less than the minimum score of 1244.68 at a private college. The maximum score at community college was 1393.96, in comparison to the maximum scores of 1600 for both private and public colleges.**
...
1. There is a significant difference in SAT scores across colleges because the p-value exceeds the alpha value.
2. Specifically, community college SAT scores differ the most from private and public colleges.
3. The average SAT scores at private colleges are 366.96 points higher and at public schools are 292.55 points higher than community colleges. Public and private SAT scores only differ slightly, with private colleges having SAT scores that are 74.4 points higher than public colleges.

Private Colleges Have The Highest SAT Scores

Data shows that students at private colleges have a higher SAT score than students at public colleges, with an average score that is 74.4 points higher.





Community Colleges Have Much Lower SAT Scores

Data shows that average SAT scores for private and public colleges around 300 or more points above the average score at a community college.
